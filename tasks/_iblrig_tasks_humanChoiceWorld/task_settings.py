...
# TASK
NTRIALS = 200  # Number of trials for the current session
...
ITI_CORRECT = 0.2  # how long the stim should stay visible after CORRECT choice
ITI_ERROR = 1  # how long the stim should stay visible after ERROR choice
# VISUAL STIM
...
# TODO: DEFINE A TONE FOR CORRECT RESPONSES
CORRECT_TONE_DURATION = 0.2  # Length of tone
CORRECT_TONE_FREQUENCY = 10000  # 5KHz
CORRECT_TONE_AMPLITUDE = 0.0272  # [0->1] 0.0272 for 70dB SPL Xonar
